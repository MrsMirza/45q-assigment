...
let vehicles :string[] = ["honda city","alto","civic"];
...
let family:string[] = ["ruba","ami","papa"];
...
let favPlaces:string[] = ["pakistan","turkey","dubai","singapor","switzerland"];
...
let cities:string[] = ["karachi","lahore","peshawar","sawat"];
...
function descibe_city(city : string, country:string = "pakistan"){
...
let myCar: car = creat_car("toyota","corolla",{color:"silver", year:"2019"})
console.log(myCar);